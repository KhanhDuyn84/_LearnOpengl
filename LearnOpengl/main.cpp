...
int main()
{
	...
	unsigned char* image = SOIL_load_image("../Resources/Images/container.jpg", &width, &height, &channels, SOIL_LOAD_AUTO);
	...
	image = SOIL_load_image("../Resources/Images/awesomeface.png", &width, &height, &channels, SOIL_LOAD_AUTO);
	...
	triangleShader.setInt("ourTexture1", 1);
